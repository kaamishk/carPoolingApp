...
class SetDriverLocationWidget extends StatefulWidget {
  const SetDriverLocationWidget({
    Key? key,
    this.locationTitle,
  }) : super(key: key);
  ...
  @override
  _SetDriverLocationWidgetState createState() =>
      _SetDriverLocationWidgetState();
}

class _SetDriverLocationWidgetState extends State<SetDriverLocationWidget> {
